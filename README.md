...
Next steps
Include additional variables such as release frequency, controller support and player tags.
Use segmentation or statistical testing to further verify observed group differences.
Expand the dataset with multi-year data to compare long-term market trends.
